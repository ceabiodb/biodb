# Makefile for biodb extensions packages, version 1.4.0
# vi: ft=make
...
test.long: install
	if test -d tests/long ; then $(R) $(RFLAGS) -e "library($(PKG_NAME));Sys.setenv(TESTTHAT_REPORTER='$(TESTTHAT_REPORTER)');testthat::test_dir('tests/long')" ; fi
endif
