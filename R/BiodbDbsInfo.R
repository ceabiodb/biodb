...
BiodbDbsInfo$methods( .initDbsInfo = function() {
	...
	.self$.define('chemspider',             name = 'ChemSpider',    scheduler.n = 3, entry.content.type = 'xml', urls = c(base.url = "http://www.chemspider.com/", ws.url = "https://api.rsc.org/compounds/v1/"), xml.ns = "http://www.chemspider.com/")
