...
abstract: |
  A quick tour of the various features of *biodb*: creating connectors, accessing entries, converting entries into a data frame, searching for entries, dealing with mass spectra, existing connectors.
output:
