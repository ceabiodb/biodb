...
graph = kegg.path.conn$buildPathwayGraph(c('mmu00260', 'mmu01200'))
```
...
ig = kegg.path.conn$getPathwayIgraph('mmu00260')
```
...
colors <- vapply(vert[['type']], function(x) if (x == 'reaction') 'yellow' else 'green', FUN.VALUE = '', USE.NAMES = FALSE)
