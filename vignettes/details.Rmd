...
As you will see shortly in the next chapter, we use a call to a constructor to obtain an instance of the class `BiodbMain`. This means that *biodb* uses an object oriented programming (or OOP) model.
...
library by creating an instance:
```{r}
...
To the BiodbMain instance are attached several singleton class instances. Each
