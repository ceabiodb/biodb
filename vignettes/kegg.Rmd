...
```{r}
kegg.comp.ids = c('C02648', 'C06144', 'C06178', 'C02659', 'C02659', 'C01746', 'C01746', 'C00741', 'C01770', 'C01771', 'C02497', 'C16267', 'C00741', 'C01770', 'C01771', 'C02497', 'C16267', 'C02640', 'C00134', 'C00041', 'C00099', 'C00133', 'C00213', 'C01401', 'C01537', 'C02116', 'C11488', 'C07090', 'C14279', 'C00414', 'C02019', 'C08497', 'C16310', 'C11118', 'C02240')
```
...
mybiodb$message('info', paste('-------------------------------- COMP', if (is.null(comp)) 'NULL' else comp$getFieldValue('accession')))
...
mybiodb$message('info', paste('-------------------------------- ENZ', if (is.null(enz)) 'NULL' else enz$getFieldValue('accession')))
...
mybiodb$message('info', paste('-------------------------------- GENE', if (is.null(gene)) 'NULL' else gene$getFieldValue('accession')))
...
Know we will loop on all the original compounds, and count for each of them the number of pathways to which they are related.
...
We need to terminate the `Biodb` instance:
```{r}
mybiodb$terminate()
```
