test_biodburl_encoding <- function() {
    ...
    testthat::expect_equal(BiodbUrl("my.site.com")$toString(), 'my.site.com')
    testthat::expect_equal(BiodbUrl("my.site.com", c('a'))$toString(),
                           'my.site.com?a')
    testthat::expect_equal(BiodbUrl("my.site.com", c('a'=2))$toString(),
                           'my.site.com?a=2')
    testthat::expect_equal(BiodbUrl("my.site.com", c('a'=2, 'n'))$toString(),
                           'my.site.com?a=2&n')
    urlWithSpace <- BiodbUrl("my.site.com", c('a b'=2, 'n'))
    ...
    urlWithSpace <- BiodbUrl("my.site.com", c('a b'='my value', 'n'))
